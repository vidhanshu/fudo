  ...
  return (
    <Container className="flex items-center justify-between p-0 h-[calc(100vh-100px)]">
      <div className="lg:max-w-xl flex flex-col gap-10">
        <BadgeText className="hidden sm:block">More than faster 🍒</BadgeText>
        <h1 className="typo-title-hero">
          Order the food by scanning the{" "}
          <span className="text-primary-main">QR</span>
        </h1>
        ...
        <div className="hidden sm:flex gap-2">
          ...
          <div>
            ...
            <span className="flex gap-2">
              <span className="text-sm md:text-base flex gap-1">
                <BsStarFill size={20} color="#FFC107" /> 4.5
              </span>
