                ...
                >
                    {
                        CATEGORIES.map(({ _id, name, Icon }, index) => (
                            <SwiperSlide key={_id}>
                                <Link href="/" className="group h-[150px] rounded-lg bg-primary-light flex flex-col gap-4 items-center justify-center p-4 hover:bg-primary-main hover:text-white transition-all">
                                    <div className="p-4 bg-white rounded-full">
                                        <Icon color="black" size={25} />
                                    </div>
                                    <div >
                                        <h4 className="text-sm">{name} <span className="hidden group-hover:inline">→</span></h4>
                                    </div>
                                </Link>
                            </SwiperSlide>
                        ))
